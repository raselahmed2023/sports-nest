  ...
  return (
    <section className="bg-base-200 py-20 px-4">
      <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
        ...
        <p className="text-base-content/60 text-base sm:text-lg max-w-xl">
          Football turfs, badminton courts, swimming lanes and more reserve your
          slot in seconds. No calls, no waiting.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-4 pt-6 border-t border-base-300 w-full">
          {[
