    ...
    <section className="py-20 bg-base-200">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2"> Book your facility in 3 easy steps</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((step) => (
            <div key={step.id} className="bg-base-100 p-6 rounded-2xl shadow-sm text-center justify-items-center">
