            ...
            <div className="card-body p-4">
                ...
                <div className="card-actions mt-3">
                    <Link href={`/facility/${facility._id}`}>
                        <button className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2 rounded-full shadow-md shadow-green-600/10 transition-all duration-300 hover:-translate-y-0.5 w-full justify-center">  Book Now </button>
                    </Link>
                </div>
